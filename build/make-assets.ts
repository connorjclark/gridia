...
function makeAssetsFromUrizen() {
  // 12x12 sprites, 50x50 of them. With 1 pixel separators.
  const dir = '/Users/connorclark/Downloads/urizen-onebit-tilesets-aug-2020';
  runImageMagick([
    'convert',
    `${dir}/urizen-onebit-tileset.png`,
    '+set', 'date:modify',
    '-crop 50x1@ -shave 1 +append',
    '-crop 1x50@ -shave 1 -append',
    'worlds/urizen-world/graphics/tileset.png',
  ]);
}

makeAssetsFromOryx16Bit();
makeAssetsFromUrizen();
